 ...
 */
class SpecialGroupArticle extends \CMS\AdminBundle\Entity\SpecialGroupArticle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'position', 'isActive', 'articles');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpecialGroupArticle $proxy) {
